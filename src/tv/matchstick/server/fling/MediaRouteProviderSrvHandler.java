    ...
    public final void handleMessage(Message message) {
        ...
        if (routeProvider != null) {
            ...
            case 1: // CLIENT_MSG_REGISTER
                flag = MediaRouteProviderSrv.register(routeProvider, messenger,
                        requestId, arg);
                break;
            ...
            case 3: // CLIENT_MSG_CREATE_ROUTE_CONTROLLER
                ...
                if (routeId == null) {
                    ...
                    flag = MediaRouteProviderSrv.createRouteController(
                            routeProvider, messenger, requestId, arg, routeId);
                }
                break;
            ...
            if (MediaRouteProviderSrv.isDebugable())
                Log.d("MediaRouteProviderSrv",
                        (new StringBuilder())
                                ...
                                .append(", arg=").append(arg).append(", obj=")
                                .append(obj).append(", data=").append(data)
                                .toString());
