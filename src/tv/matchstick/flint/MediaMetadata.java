 ...
 * <p>
 * Note that the Flint protocol limits which metadata fields can be used for a
 * given media type. When a MediaMetadata object is serialized to JSON for
 * delivery to a Flint receiver, any predefined fields which are not supported
...
public class MediaMetadata {
    ...
    private static final ValueTypesChecker mChecker = new ValueTypesChecker()
            .addKeyValue("tv.matchstick.flint.metadata.CREATION_DATE",
                    "creationDateTime", VALUE_TYPE_ISO_8601_STRING)
            .addKeyValue("tv.matchstick.flint.metadata.RELEASE_DATE",
                    "releaseDate", VALUE_TYPE_ISO_8601_STRING)
            .addKeyValue("tv.matchstick.flint.metadata.BROADCAST_DATE",
                    "originalAirdate", VALUE_TYPE_ISO_8601_STRING)
            .addKeyValue("tv.matchstick.flint.metadata.TITLE", "title",
                    VALUE_TYPE_STRING)
            .addKeyValue("tv.matchstick.flint.metadata.SUBTITLE", "subtitle",
                    VALUE_TYPE_STRING)
            .addKeyValue("tv.matchstick.flint.metadata.ARTIST", "artist",
                    VALUE_TYPE_STRING)
            .addKeyValue("tv.matchstick.flint.metadata.ALBUM_ARTIST",
                    "albumArtist", VALUE_TYPE_STRING)
            .addKeyValue("tv.matchstick.flint.metadata.ALBUM_TITLE",
                    "albumName", VALUE_TYPE_STRING)
            .addKeyValue("tv.matchstick.flint.metadata.COMPOSER", "composer",
                    VALUE_TYPE_STRING)
            .addKeyValue("tv.matchstick.flint.metadata.DISC_NUMBER",
                    "discNumber", VALUE_TYPE_INT)
            .addKeyValue("tv.matchstick.flint.metadata.TRACK_NUMBER",
                    "trackNumber", VALUE_TYPE_INT)
            .addKeyValue("tv.matchstick.flint.metadata.SEASON_NUMBER",
                    "season", VALUE_TYPE_INT)
            .addKeyValue("tv.matchstick.flint.metadata.EPISODE_NUMBER",
                    "episode", VALUE_TYPE_INT)
            .addKeyValue("tv.matchstick.flint.metadata.SERIES_TITLE",
                    "seriesTitle", VALUE_TYPE_STRING)
            .addKeyValue("tv.matchstick.flint.metadata.STUDIO", "studio",
                    VALUE_TYPE_STRING)
            .addKeyValue("tv.matchstick.flint.metadata.WIDTH", "width",
                    VALUE_TYPE_INT)
            .addKeyValue("tv.matchstick.flint.metadata.HEIGHT", "height",
                    VALUE_TYPE_INT)
            .addKeyValue("tv.matchstick.flint.metadata.LOCATION_NAME",
                    "location", VALUE_TYPE_STRING)
            .addKeyValue("tv.matchstick.flint.metadata.LOCATION_LATITUDE",
                    "latitude", VALUE_TYPE_DOUBLE)
            .addKeyValue("tv.matchstick.flint.metadata.LOCATION_LONGITUDE",
    ...
    public JSONObject buildJson() {
        ...
        case MEDIA_TYPE_GENERIC:
            writeToJson(json, new String[] {
                    "tv.matchstick.flint.metadata.TITLE",
                    "tv.matchstick.flint.metadata.ARTIST",
                    "tv.matchstick.flint.metadata.SUBTITLE",
                    "tv.matchstick.flint.metadata.RELEASE_DATE" });
            break;
        case MEDIA_TYPE_MOVIE:
            writeToJson(json, new String[] {
                    "tv.matchstick.flint.metadata.TITLE",
                    "tv.matchstick.flint.metadata.STUDIO",
                    "tv.matchstick.flint.metadata.SUBTITLE",
                    "tv.matchstick.flint.metadata.RELEASE_DATE" });
            break;
        case MEDIA_TYPE_TV_SHOW:
            writeToJson(json, new String[] {
                    "tv.matchstick.flint.metadata.TITLE",
                    "tv.matchstick.flint.metadata.SERIES_TITLE",
                    "tv.matchstick.flint.metadata.SEASON_NUMBER",
                    "tv.matchstick.flint.metadata.EPISODE_NUMBER",
                    "tv.matchstick.flint.metadata.BROADCAST_DATE" });
            break;
        case MEDIA_TYPE_MUSIC_TRACK:
            writeToJson(json, new String[] {
                    "tv.matchstick.flint.metadata.TITLE",
                    "tv.matchstick.flint.metadata.ARTIST",
                    "tv.matchstick.flint.metadata.ALBUM_TITLE",
                    "tv.matchstick.flint.metadata.ALBUM_ARTIST",
                    "tv.matchstick.flint.metadata.COMPOSER",
                    "tv.matchstick.flint.metadata.TRACK_NUMBER",
                    "tv.matchstick.flint.metadata.DISC_NUMBER",
                    "tv.matchstick.flint.metadata.RELEASE_DATE" });
            break;
        case MEDIA_TYPE_PHOTO:
            writeToJson(json, new String[] {
                    "tv.matchstick.flint.metadata.TITLE",
                    "tv.matchstick.flint.metadata.ARTIST",
                    "tv.matchstick.flint.metadata.LOCATION_NAME",
                    "tv.matchstick.flint.metadata.LOCATION_LATITUDE",
                    "tv.matchstick.flint.metadata.LOCATION_LONGITUDE",
                    "tv.matchstick.flint.metadata.WIDTH",
                    "tv.matchstick.flint.metadata.HEIGHT",
                    "tv.matchstick.flint.metadata.CREATION_DATE" });
            break;
        default:
