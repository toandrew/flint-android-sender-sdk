...
public class MediaControlChannel extends FlingChannel {
    ...
    private final RequestTracker mRequestTrackerLoad = new RequestTracker(yj);
    private final RequestTracker mRequestTrackerPause = new RequestTracker(yi);
    private final RequestTracker mRequestTrackerPlay = new RequestTracker(yi);
    private final RequestTracker mRequestTrackerStop = new RequestTracker(yi);
    private final RequestTracker mRequestTrackerSeed = new RequestTracker(yk);
    private final RequestTracker mRequestTrackerVolume = new RequestTracker(yi);
    private final RequestTracker mRequestTrackerMute = new RequestTracker(yi);
    ...
    public long load(RequestTrackerCallback paramdx, MediaInfo mediaInfo,
    ...
    public long pause(RequestTrackerCallback paramdx, JSONObject customData)
            throws IOException {
        JSONObject json = new JSONObject();
        long requestId = getRequestId();
    ...
    public long stop(RequestTrackerCallback paramdx, JSONObject customData)
            throws IOException {
        JSONObject json = new JSONObject();
        long requestId = getRequestId();
    ...
    public long seek(RequestTrackerCallback paramdx, long currentTime,
    ...
    public long setStreamMute(RequestTrackerCallback paramdx, boolean muted,
            JSONObject customData) throws IOException, IllegalStateException {
        JSONObject json = new JSONObject();
        long requestId = getRequestId();
    ...
    public long requestStatus(RequestTrackerCallback paramdx)
            throws IOException {
        JSONObject json = new JSONObject();
        long requestId = getRequestId();
