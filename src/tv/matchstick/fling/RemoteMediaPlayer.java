...
public class RemoteMediaPlayer implements Fling.MessageReceivedCallback {
	 ...
	 *         request.
	 */
	public PendingResult<MediaChannelResult> load(FlingManager manager,
			MediaInfo mediaInfo) {
	 ...
	 *         request.
	 */
	public PendingResult<MediaChannelResult> load(final FlingManager manager,
	 ...
	 *         request.
	 */
	public PendingResult<MediaChannelResult> pause(FlingManager manager) {
	 ...
	 *         request.
	 */
	public PendingResult<MediaChannelResult> pause(final FlingManager manager,
	 ...
	 *         request.
	 */
	public PendingResult<MediaChannelResult> stop(FlingManager manager) {
	 ...
	 *         request.
	 */
	public PendingResult<MediaChannelResult> stop(final FlingManager manager,
			final JSONObject customData) {
		return manager.executeTask(new MediaChannelResultHandler() {
			protected void execute(FlingClientImpl client) {
				synchronized (mLock) {
	 ...
	 *         request.
	 */
	public PendingResult<MediaChannelResult> play(FlingManager manager) {
	 ...
	 *         request.
	 */
	public PendingResult<MediaChannelResult> play(final FlingManager manager,
			final JSONObject customData) {
		return manager.executeTask(new MediaChannelResultHandler() {
			protected void execute(FlingClientImpl client) {
				synchronized (mLock) {
	 ...
	 *         request.
	 */
	public PendingResult<MediaChannelResult> seek(FlingManager manager,
			long position) {
	 ...
	 *         request.
	 */
	public PendingResult<MediaChannelResult> seek(final FlingManager manager,
	...
	public PendingResult<MediaChannelResult> setStreamVolume(
			FlingManager manager, double volume)
			throws IllegalArgumentException {
	 ...
	 */
	public PendingResult<MediaChannelResult> setStreamVolume(
			final FlingManager manager, final double volume,
		...
		return manager.executeTask(new MediaChannelResultHandler() {
			protected void execute(FlingClientImpl cllient) {
				synchronized (mLock) {
					mMessageSender.setApiClient(manager);
					try {
	...
	public PendingResult<MediaChannelResult> setStreamMute(
			FlingManager manager, boolean muteState) {
	 ...
	 */
	public PendingResult<MediaChannelResult> setStreamMute(
			final FlingManager manager, final boolean muteState,
			final JSONObject customData) {
		return manager.executeTask(new MediaChannelResultHandler() {
			protected void execute(FlingClientImpl client) {
				synchronized (mLock) {
	...
	private class MessageSenderImpl implements MessageSender {
		 ...
		 * @param manager
		 */
		public void setApiClient(FlingManager manager) {
		...
		public void sendTextMessage(String namespace, String message,
			...
			Fling.FlingApi.sendMessage(manager, namespace, message)
